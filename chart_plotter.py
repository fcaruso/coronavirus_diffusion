...
def plot_national_charts(list_dates,
                         array_sum_of_concentrations, 
                         array_sum_of_swabs, 
                         array_sum_of_positives,
    ...
    cp.plot_date(list_dates,array_sum_of_concentrations, linestyle='solid',label="percentuale tamponi positivi")
    ax.set_ylabel("% Positivi ")
    ...
    list_dates_offset_left  = [ e - bar_width / 2 for e in list_dates ]
    list_dates_offset_right = [ e + bar_width / 2 for e in list_dates ]
    rects_swabs = cp2.bar(list_dates_offset_left, array_sum_of_swabs, bar_width, label='Tamponi',color="green")
    rects_positives = cp2.bar(list_dates_offset_right, array_sum_of_positives, bar_width, label="Positivi",color="red")
    cp2.legend( ( rects_swabs, rects_positives), ("tamponi", "tamponi positivi"),loc='upper left',bbox_to_anchor=(0., 0.8,0.8,0.1) )
    ax2 = pl.gca()
    ax2.set_ylabel(" Tamponi ")
...
def plot_regional_averages(sorted_average_map, output_dir, file_prefix):
